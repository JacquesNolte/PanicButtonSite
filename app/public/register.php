...
if(isset($_POST['action'])) {
	...
	$registerMessage = 'The resgister form has triggered the PHP';
    ...
    if($_POST['action'] === 'register') {
		...
		$register = $wrapper->signup($email, $firstname, $lastname, $phonenumber, $password);
		
		if (strpos($register, 'User already exists')) {
						...
						<div class="row">
							<div class="col-lg-8 col-md-8">
								...
								<form method='post' action=''>
                                    ...
                                    <div class="mt-10">
										<input type="text" name="phonenumber" placeholder="Phone Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" required class="single-input">
									</div>
                                    <div class="mt-10">
