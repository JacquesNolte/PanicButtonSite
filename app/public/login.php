...
if(isset($_POST['action'])) {
    ...
    if($_POST['action'] === 'login') {
        ...
        $error = $wrapper->authenticate($email, $password);

        if(empty($error)) {
            header('Location: secure.php');
            exit;
        }else{
			// $login_error = 'The username or password entered is incorrect!';
			$login_error = $error;
        }
    }
}
					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								...
								<p class="login_error" style="color:red;"><?php if(isset($login_error)){echo $login_error;} ?></p>
