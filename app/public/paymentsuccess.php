					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Payment Has Been Received</h2>
								<p class="text-white">Good news, we have received your payment.</p>
							</div>							
						</div>
					</div>
				</div>
			...
			<section class="about-generic-area section-gap">
				<div class="container border-top-generic">
					...
					<div class="row">
                        ...
                        <p>Delivery is to be arranged with courier</p>
					</div>
				</div>
			</section>
			<!-- End Generic Start -->		
